...
const ExpenseForm = (props) => {
       ...
       const [showFormOrNot,setShowFormOrNot] = useState(true);
  ...
  const showFormClickHandler = (event) => {
    setShowFormOrNot(true);
  }
  ...
  if(showFormOrNot){
    ...
    return <p onClick={showFormClickHandler}>Show Expense Form</p>
  }
